      ...
      <div className='bg-[#E5E5E5] flex relative'>
        <div className='max-w-6xl mx-auto py-10 pb-32 px-5'>
          ...
          <div className='my-10 py-12 px-5 sm:px-8 bg-white ring-1 ring-offset-2 ring-slate-50 rounded-lg'>
            <h2
              className='text-[#444343] font-bold text-2xl text-center mb-11'
              id='price'
            >
          ...
          {/* Pros Cons */}
          <div
            className='my-10 py-12 px-5 sm:px-8 bg-white ring-1 ring-offset-2 ring-slate-50 rounded-lg'
            id='pros-cons'
          >
            ...
            <div className='font-bold'>
              <div className='max-w-3xl mx-auto'>
                <div>
                  ...
                  interior space and its engine power was better. This
                  generation of Honda Civic was available in three
                  transmissions: a 4-speed and 5-speed manual, and a 2-speed
                  semi-automatic which Honda used to call “Hondamatic”.
                  Previously a subcompact, since 2000 the Civic has been
                  categorized as a compact car.
                </div>
          ...
          {/* Colors */}
          <div
            className='mt-10 py-12  px-5 sm:px-8 bg-white ring-1 ring-offset-2 ring-slate-50 rounded-lg'
            id='colors'
          >
            <h2 className='text-[#444343] font-bold text-2xl text-center mb-11'>
              Colors
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 text-center sm:text-start'>
      ...
      <div>
        ...
        <div className='flex sm:justify-start justify-center'>
          <Rating ratingValue={4} transition initialValue={4} />
        </div>
...
const SideMenu = () => {
  ...
  return (
    <>
      <div className='w-[200px] min-h-[350px]  hidden mdLg:block bg-black text-center absolute top-12 rounded-r-[20px] py-6'>
        <div className=' text-white text-lg mb-6'>Honda Civic</div>
        <div onClick={() => handleScroll('price')} className='cursor-pointer'>
          <div className='font-bold text-white my-4 navItems'>Price</div>
          <div className='borderAnimation h-[1px] w-0 bg-white transition-all duration-300'></div>
        </div>
        <div
          onClick={() => handleScroll('pros-cons')}
          className='cursor-pointer'
        >
          <div className='font-bold text-white my-4 navItems'>Pros & Cons</div>
          <div className='borderAnimation h-[1px] w-0 bg-white transition-all duration-300'></div>
        </div>
        <div
          ...
          className='cursor-pointer'
        >
          <div className='font-bold text-white my-4 navItems'>Overview</div>
          <div className='borderAnimation h-[1px] w-0 bg-white transition-all duration-300'></div>
        </div>
        <div onClick={() => handleScroll('reviews')} className='cursor-pointer'>
          <div className='font-bold text-white my-4 navItems'>Reviews</div>
          <div className='borderAnimation h-[1px] w-0 bg-white transition-all duration-300'></div>
        </div>
        <div onClick={() => handleScroll('colors')} className='cursor-pointer'>
          <div className='font-bold text-white my-4 navItems'>Colors</div>
          <div className='borderAnimation h-[1px] w-0 bg-white transition-all duration-300'></div>
        </div>
      </div>
