  ...
  return (
    <div className='min-h-[80px]'>
      <div className='w-full relative'>
        ...
        <select className='bg-white relative p-3 w-full transition-all ease-in-out duration-[.15s] border-[#B5B5B5] border-2 rounded-md focus-visible:outline-none focus:border-[#80bdff] focus:shadow-[0px_0px_0px_0.2rem_rgb(0,123,255,0.25)]'>
          {options.map((option) => (
            <option
              id={option.value}
              disabled={disabled}
